...
op_price['cod_negociacao'] = df_price['cod_negociacao']
...
bs_mse_moneyness = {
    ...
    'R^2': [
        calculo_MSE(op_price[op_price['moneyness'] == 'ITM']),
        calculo_MSE(op_price[op_price['moneyness'] == 'ATM']),
        calculo_MSE(op_price[op_price['moneyness'] == 'OTM'])
    ]
      }

bs_mse_moneyness = pd.DataFrame(bs_r2_moneyness)
print(bs_mse_moneyness)
...
bs_mse_ano = {
    ...
    'R^2':   [ 
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2015]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2016]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2017]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2018]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2019]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2020]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2021]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2022]),
        calculo_MSE(op_price[op_price['data_pregao'].dt.year == 2023])
          ]
        }       

bs_mse_ano = pd.DataFrame(bs_mse_ano)
print(bs_mse_ano)
